...
if [ ! -f UNIREF30_READY ]; then
  downloadFile "http://wwwuser.gwdg.de/~compbiol/kagglefold/uniref30_2103.tar.gz" "uniref30_2103.tar.gz"
...
if [ ! -f COLABDB_READY ]; then
  downloadFile "http://wwwuser.gwdg.de/~compbiol/kagglefold/kagglefold_envdb_202108.tar.gz" "kagglefold_envdb_202108.tar.gz"
  tar xzvf "kagglefold_envdb_202108.tar.gz"
  mmseqs tsv2exprofiledb "kagglefold_envdb_202108" "kagglefold_envdb_202108_db"
  # TODO: split memory value for createindex?
  mmseqs createindex "kagglefold_envdb_202108_db" tmp2 --remove-tmp-files 1
  touch COLABDB_READY
fi
