# KaggleFold
<p align="center"><img src="https://github.com/vfalbor/KaggleFold/raw/main/.github/KaggleFold_Marv_Logo.png" height="250"/></p>

-----------------
**New Updates**
```diff
+ 26Jan2022 AlphaFold2_mmseqs2, AlphaFold2_batch and kagglefold_batch's multimer complexes predictions are 
...
| :-------- | -------  | --------- | ------- | --------- | ----------- |
| [AlphaFold2_mmseqs2](https://colab.research.google.com/github/sokrypton/KaggleFold/blob/main/AlphaFold2.ipynb) | Yes | Yes | Yes | No | Yes | 
| [AlphaFold2_batch](https://colab.research.google.com/github/sokrypton/KaggleFold/blob/main/batch/AlphaFold2_batch.ipynb) | Yes | Yes | Yes | No | Yes | 
| [RoseTTAFold](https://colab.research.google.com/github/sokrypton/KaggleFold/blob/main/RoseTTAFold.ipynb) | Yes | No | Yes | No | No | 
...
| [AlphaFold2_advanced](https://colab.research.google.com/github/sokrypton/KaggleFold/blob/main/beta/AlphaFold2_advanced.ipynb) | Yes | Yes | Yes | Yes | No |
||
| **OLD retired notebooks** | | | | | |
| [AlphaFold2_complexes](https://colab.research.google.com/github/sokrypton/KaggleFold/blob/main/AlphaFold2_complexes.ipynb) | No | Yes | No | No | No | 
| [AlphaFold2_jackhmmer](https://colab.research.google.com/github/sokrypton/KaggleFold/blob/main/beta/AlphaFold_wJackhmmer.ipynb) | Yes | No | Yes | Yes | No |
| [AlphaFold2_noTemplates_noMD](https://colab.research.google.com/github/sokrypton/KaggleFold/blob/main/verbose/alphafold_noTemplates_noMD.ipynb) |
| [AlphaFold2_noTemplates_yesMD](https://colab.research.google.com/github/sokrypton/KaggleFold/blob/main/verbose/alphafold_noTemplates_yesMD.ipynb) |
...
- KaggleFold Tutorial presented at the Boston Protein Design and Modeling Club. [[video]](https://www.youtube.com/watch?v=Rfw7thgGTwI) [[slides]](https://docs.google.com/presentation/d/1mnffk23ev2QMDzGZ5w1skXEadTe54l8-Uei6ACce8eI). 

### Projects based on KaggleFold

- [Run KaggleFold (AlphaFold2_advanced) on your local computer](https://github.com/YoshitakaMo/localkagglefold) by Yoshitaka Moriwaki
...
```diff
  ...
  11Nov2021  KaggleFold can be installed locally using pip!
